...
@export var dialogue_Intro_01: DialogueResource = load("res://Dialogue/Cine_Intro_01.dialogue")
@export var dialogue_Intro_02: DialogueResource = load("res://Dialogue/Cine_Intro_02.dialogue")
